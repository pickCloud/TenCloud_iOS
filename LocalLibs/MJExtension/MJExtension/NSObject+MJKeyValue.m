...
+ (instancetype)mj_objectWithKeyValues:(id)keyValues context:(NSManagedObjectContext *)context
{
    ...
    if ([self isSubclassOfClass:[NSManagedObject class]] && context) {
        ...
        NSManagedObject *newObject = [[[self class] alloc] initWithEntity:entity insertIntoManagedObjectContext:nil];
        return [newObject mj_setKeyValues:keyValues context:context];
