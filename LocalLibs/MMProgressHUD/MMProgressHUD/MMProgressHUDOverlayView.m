...
- (instancetype)initWithFrame:(CGRect)frame overlayMode:(MMProgressHUDWindowOverlayMode)overlayMode {
    ...
    if (self) {
        ...
        //for test
        //_overlayColor = [UIColor greenColor].CGColor;
...
//    CGColorRef thirdColor = CGColorCreateCopyWithAlpha(self.overlayColor, 0.5f);
    //for test
    CGColorRef firstColor = CGColorCreateCopyWithAlpha(self.overlayColor, 0.f);
    CGColorRef secondColor = CGColorCreateCopyWithAlpha(self.overlayColor, 0.175f);
    CGColorRef thirdColor = CGColorCreateCopyWithAlpha(self.overlayColor, 0.2f);
...
- (void)_drawLinearOverlayInRect:(CGRect)rect {
    ...
    //for test
    CGColorRef linearColor = CGColorCreateCopyWithAlpha(self.overlayColor, 0.15f);
