...
- (void)setNeedsNavigationBarUpdateForShadowImageHidden:(BOOL)hidden {
    ...
    self.navigationBar.shadowImage = hidden ? [UIImage new] : [UIImage new];
    if (hidden)
    {
        self.navigationBar.layer.shadowOpacity = 0;
        //fromVC.fakeNavigationBar.layer.shadowColor = [UIColor darkGrayColor].CGColor;
        //fromVC.fakeNavigationBar.layer.shadowOffset = CGSizeMake(0, 0);
        //fromVC.fakeNavigationBar.layer.shadowOpacity = 0.5;//阴影透明度，默认0
        //fromVC.fakeNavigationBar.layer.shadowRadius = 1;//阴影半径，默认3
    }else
    {
        self.navigationBar.layer.shadowColor = [UIColor darkGrayColor].CGColor;
        self.navigationBar.layer.shadowOffset = CGSizeMake(0, 0);
        self.navigationBar.layer.shadowOpacity = 0.32;//阴影透明度，默认0
        self.navigationBar.layer.shadowRadius = 1;//阴影半径，默认3
    }
...
- (void)addFakeNavigationBar {
    ...
    if (!fromVC.fakeNavigationBar && ![fromVC vhl_navBarHidden]) {
        ...
        fromVC.fakeNavigationBar.layer.shadowColor = [UIColor darkGrayColor].CGColor;
        fromVC.fakeNavigationBar.layer.shadowOffset = CGSizeMake(0, 0);
        fromVC.fakeNavigationBar.layer.shadowOpacity = 0.32;//阴影透明度，默认0
        fromVC.fakeNavigationBar.layer.shadowRadius = 1;//阴影半径，默认3
    ...
    if (!toVC.fakeNavigationBar && ![toVC vhl_navBarHidden]) {
        ...
        toVC.fakeNavigationBar.layer.shadowColor = [UIColor darkGrayColor].CGColor;
        toVC.fakeNavigationBar.layer.shadowOffset = CGSizeMake(0, 0);
        toVC.fakeNavigationBar.layer.shadowOpacity = 0.32;//阴影透明度，默认0
        toVC.fakeNavigationBar.layer.shadowRadius = 1;//阴影半径，默认3
