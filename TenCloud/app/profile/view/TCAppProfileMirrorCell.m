...
@interface TCAppProfileMirrorCell ()
@property (nonatomic, strong)   TCMirror            *mirror;
...
@implementation TCAppProfileMirrorCell
...
{
    _nameLabel.text = mirror.name;
    _versionLabel.text = mirror.version;
    _updateTimeLabel.text = [NSString dateTimeStringFromTimeInterval:mirror.updateTime];
    [_seperatorView setHidden:!isShow];
}
